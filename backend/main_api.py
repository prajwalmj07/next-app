...
async def get_graph_data(deviceSerialNumber: str, graph_type: Literal["voltage", "current", "power"], data_per_page: int = 15):
...
async def get_device_info(device_serial: str):
    raw_data = await fetch_data(device_serial, 1)
